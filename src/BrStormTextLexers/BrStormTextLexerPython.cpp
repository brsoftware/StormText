/**
 * @brief BrStormTextLexerPython.cpp: A file of the StormText project.
...
#include "BrStormTextLexerPython.hpp"

#include <Qsci/qsciapis.h>


BrStormTextLexerPython::BrStormTextLexerPython(QFont font, QColor color, QObject *parent)
    : QsciLexerPython(parent)
{    
    setV2UnicodeAllowed(true);
    setV3BinaryOctalAllowed(false);
    setV3BytesAllowed(false);
