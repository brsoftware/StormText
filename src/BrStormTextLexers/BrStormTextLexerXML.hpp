/**
 * @brief BrStormTextLexerXML.hpp: A file of the StormText project.
...
#ifndef BRSTORMTEXTLEXERXML_HPP
#define BRSTORMTEXTLEXERXML_HPP


#include <Qsci/qscilexerxml.h>


class BrStormTextLexerXML : public QsciLexerXML
{
    Q_OBJECT

public:

    BrStormTextLexerXML(QFont font, QColor color, QObject *parent = nullptr);
