/**
 * @brief BrStormTextLexerMatlab.cpp: A file of the StormText project.
...
#include "BrStormTextLexerMatlab.hpp"

#include <Qsci/qsciapis.h>


BrStormTextLexerMatlab::BrStormTextLexerMatlab(QFont font, QColor color, QObject *parent)
