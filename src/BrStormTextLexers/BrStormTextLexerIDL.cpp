/**
 * @brief BrStormTextLexerIDL.cpp: A file of the StormText project.
...
#include "BrStormTextLexerIDL.hpp"

#include <Qsci/qsciapis.h>


BrStormTextLexerIDL::BrStormTextLexerIDL(QFont font, QColor color, QObject *parent)
    : QsciLexerIDL(parent)
{
...
const char *BrStormTextLexerIDL::keywords(int set) const
{
    if (set == 1)
