/**
 * @brief BrStormTextLexerC.C: A file of the StormText project.
...
BrStormTextLexerC::BrStormTextLexerC(QFont font, QColor color, QObject *parent)
    : QsciLexerCPP(parent)
{
...
const char *BrStormTextLexerC::keywords(int set) const
{
    if (set == 1)
