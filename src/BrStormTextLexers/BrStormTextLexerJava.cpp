/**
 * @brief BrStormTextLexerJava.cpp: A file of the StormText project.
...
#include "BrStormTextLexerJava.hpp"

#include <Qsci/qsciapis.h>


BrStormTextLexerJava::BrStormTextLexerJava(QFont font, QColor color, QObject *parent)
...
const char *BrStormTextLexerJava::keywords(int set) const
{
    if (set == 1)
