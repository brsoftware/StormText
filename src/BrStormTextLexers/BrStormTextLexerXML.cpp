/**
 * @brief BrStormTextLexerXML.cpp: A file of the StormText project.
...
#include "BrStormTextLexerXML.hpp"

#include <Qsci/qsciapis.h>


BrStormTextLexerXML::BrStormTextLexerXML(QFont font, QColor color, QObject *parent)
    : QsciLexerXML(parent)
{
    ...
    setColor(QColor("#FF6D00"), QsciLexerHTML::UnknownTag);
    setColor(QColor("#3966FF"), QsciLexerHTML::Attribute);
    setColor(QColor("#3966FF"), QsciLexerHTML::UnknownAttribute);
