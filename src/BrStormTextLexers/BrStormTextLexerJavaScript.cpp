/**
 * @brief BrStormTextLexerJavaScript.cpp: A file of the StormText project.
...
#include "BrStormTextLexerJavaScript.hpp"

#include <Qsci/qsciapis.h>


BrStormTextLexerJavaScript::BrStormTextLexerJavaScript(QFont font, QColor color, QObject *parent)
...
const char *BrStormTextLexerJavaScript::keywords(int set) const
{
    if (set == 1)
